...
## Temperature Sweep
Run TexygenScript.ipynb and make sure the generated samples are saved in the gen_data folder
Then compute testBLEU and selfBLEU scores using BLEU-Util
With AreaUtil, get the areas for each datasize for each model 
