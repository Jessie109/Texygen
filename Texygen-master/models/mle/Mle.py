...
#         super().__init__()
        ...
        self.oracle_file = 'save/mle/oracle.txt'
        self.generator_file = 'save/mle/generator.txt'
        self.test_file = 'save/mle/test_file.txt'
...
#         self.add_metric(docsim)
    ...
    def evaluate(self):
        ...
        if self.log is not None:
            if self.epoch == 0 or self.epoch == 1:
                ...
                self.log.write('\n')
            scores = super(Mle, self).evaluate()
            for score in scores:
                self.log.write(str(score)+',')
            self.log.write('\n')
            return scores
        return super(Mle).evaluate()
    ...
    def train_real(self, size,itr, data_loc=None):
        ...
        for alpha in self.temps:
            gen_file= 'gen_data/mle/coco/'+str(itr)+'_'+str(size)+'_'+str(alpha)+'.txt'
