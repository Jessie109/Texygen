...
class Rankgan(Gan):
    def __init__(self, oracle=None):
        ...
        self.oracle_file = 'save/rankgan/oracle.txt'
        self.generator_file = 'save/rankgan/generator.txt'
        self.test_file = 'save/rankgan/test_file.txt'
    ...
    def evaluate(self):
        ...
        if self.log is not None:
            if self.epoch == 0 or self.epoch == 1:
                ...
                self.log.write('\n')
            scores = super(Rankgan,self).evaluate()
            for score in scores:
...
#         self.add_metric(docsim)
    ...
    def train_real(self, size,itr, data_loc=None):
        ...
        for alpha in self.temps:
            gen_file= 'gen_data/rankgan/coco/'+str(itr)+'_'+str(size)+'_'+str(alpha)+'.txt'
